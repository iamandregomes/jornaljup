...
Redux::setSection( $opt_name , array(
        'icon'      => ' el-icon-smiley',
        'title'     => esc_html__( 'Logotipo', 'herald' ),
        ...
        'fields'    => array(
            ...
            array(
                ...
                'default'   => array( 'url' => esc_url( get_template_directory_uri().'/assets/img/JUP.png' ) ),
            ),
            ...
            array(
                ...
                'type'      => 'media',
                'url'       => true,
                'title'     => esc_html__( 'Mini Logotipo', 'herald' ),
                'subtitle'      => esc_html__( 'Optionally upload another logo which may be used as mobile/tablet logo', 'herald' ),
                'default'   => array( 'url' => esc_url( get_template_directory_uri().'/assets/img/jup_mini.png' ) ),
            ),
            ...
            array(
                ...
                'type'      => 'media',
                'url'       => true,
                'title'     => esc_html__( 'Imagem destaque padrão', 'herald' ),
                ...
                'default'   => array( 'url' => esc_url( get_template_directory_uri().'/assets/img/featured.png' ) ),
            )
        ) )
);
...
Redux::setSection( $opt_name , array(
        ...
        'title'     => esc_html__( 'Cabeçalho', 'herald' ),
        'fields'    => array(
)));
...
Redux::setSection( $opt_name , array(
        'icon'      => '',
        'title'     => esc_html__( 'Secções', 'herald' ),
        'heading' => false,
        'subsection' => true,
        'fields'    => array(
             ...
             array(
                    ...
                    'type'      => 'sortable',
                    'mode'      => 'checkbox',
                    'title'     => esc_html__( 'Secções do Cabeçalho', 'herald' ),
                    'subtitle'  => esc_html__( 'Escolha a ordem que deseja', 'herald' ),
                    'options'   => array(
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-screen',
        'title'     => esc_html__( 'Conteúdo', 'herald' ),
...
Redux::setSection( $opt_name , array(
        ...
        'title'     => esc_html__( 'Rodapé', 'herald' ),
...
Redux::setSection( $opt_name , array(
        'icon'      => ' el-icon-list',
        'title'     => esc_html__( 'Barra lateral', 'herald' ),
        'class'     => 'sidgen',
...
Redux::setSection( $opt_name , array(
        ...
        'title'     => esc_html__( 'Estrutura', 'herald' ),
        'heading' => false,
        'fields'    => array(
        ) )
);
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-stop',
        'title'     => esc_html__( 'Destaques', 'herald' ),
        'heading' => false,
        'fields'    => array(
        ) )
);
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-pencil',
        'title'     => esc_html__( 'Notícia', 'herald' ),
        'heading' => false,
        'fields'    => array(
        ) )
);
...
Redux::setSection( $opt_name ,  array(
        ...
        'title'     => esc_html__( 'Página', 'herald' ),
...
Redux::setSection( $opt_name , array(
        'icon'      => ' el-icon-tag',
        'title'     => esc_html__( 'Mais sobre', 'herald' ),
...
Redux::setSection( $opt_name ,  array(
        'icon'      => 'el-icon-user',
        'title'     => esc_html__( 'Página de autor', 'herald' ),
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-search',
        'title'     => esc_html__( 'Pesquisa livre', 'herald' ),
...
Redux::setSection( $opt_name ,  array(
        ...
        'title'     => esc_html__( 'Arquivo', 'herald' ),
...
Redux::setSection( $opt_name , array(
        ...
        'title'     => esc_html__( 'Tipografia', 'herald' ),
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-usd',
        'title'     => esc_html__( 'Publicidade', 'herald' ),
...
Redux::setSection( $opt_name , array(
        'icon'      => 'el-icon-wrench',
        'title'     => esc_html__( 'Diversos', 'herald' ),
